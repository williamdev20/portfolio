...
export default function Certification() {
    ...
    return (
       <section id="certificacao" className="bg-[#789048] flex flex-col bg-cover min-h-screen bg-center items-center overflow-x-hidden">
            <h2 className="text-center text-white text-5xl mt-10 mb-auto font-bold">Certificações</h2>

            <div className="flex flex-row items-center mb-auto gap-4 md:gap-5">
